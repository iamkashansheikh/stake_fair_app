...
//         backOdds: [
//           {'price': '1.35', 'size': '118.00'},
//           {'price': '1.48', 'size': '215.00'},
//         ],
//         layOdds: [
//           {'price': '1.45', 'size': '540.00'},
//           {'price': '1.50', 'size': '800.00'},
//         ], 
//       ),
//       PlayerMarketTile(
//       image:AssetImage('assets/images/market.png'),
//         title: 'Leicestershire', 
//         backOdds: [
//           {'price': '1.16', 'size': '530.37'},
//           {'price': '3.95', 'size': '265.00'},
//         ],
//         layOdds: [
//           {'price': '1.95', 'size': '1.20K'},
//           {'price': '1.98', 'size': '1.45K'},
//         ],
//       ),
//     ],
//   ),
...
//           Text(size, style: const TextStyle(color: Colors.white70, fontSize: 10)),
//         ],
//       ),
//     );
//   }
...
//   final List<OddsData> backOdds;
//   final List<OddsData> layOdds;
...
//           Expanded(
//             flex: 2,
//             child: Text(teamName, style: const TextStyle(fontWeight: FontWeight.bold)),
//           ),
//           ...backOdds.map((item) => OddsBox(
//                 price: item.price,
//                 size: item.size,
//                 bgColor: Colors.blue.shade600,
//               )),
//           ...layOdds.map((item) => OddsBox(
//                 price: item.price,
//                 size: item.size,
