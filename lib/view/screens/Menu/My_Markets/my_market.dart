...
class MyMarketScreen extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      Row(
                        ...
                        if (inplayController.selectedIndex == 0) {
                          return Column(
                            children: [
                              _buildMarketContainer('Please Log in, to see your bookmarks')

                            ],
                          );
                        }

                        return  _buildMarketContainer('Markets that you have recenlty viewed will be listed here.');
                      }),
                      ],
                    ),
                  ),
  ...
  Widget _buildMarketContainer(String title){
      return Container(
                            width: 10.sw,
                            height: 100.h,
                            color: Colors.white,
